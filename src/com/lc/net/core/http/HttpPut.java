...
public class HttpPut extends HttpRequestBase{
	...
	public HttpPut(String url,RequestParams requestParams) {
		this(url,requestParams,null);
	}
	public HttpPut(String url,RequestParams requestParams,HttpHeaders headers) {
		super(url,requestParams,headers);
	}
	@Override
	public Request buildRequest() {
		return getRequestBuilder().put(getRequestBody()).build();
	}
