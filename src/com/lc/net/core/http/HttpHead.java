...
public class HttpHead extends HttpRequestBase {
	...
	public HttpHead(String url, RequestParams requestParams) {
		this(url, requestParams, null);
	}

	public HttpHead(String url, RequestParams requestParams, HttpHeaders headers) {
		super(url, requestParams, headers);
	}

	@Override
	public Request buildRequest() {
		return getRequestBuilder().head().build();
	}
