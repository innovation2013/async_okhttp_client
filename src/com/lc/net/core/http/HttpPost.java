...
public class HttpPost extends HttpRequestBase{
	...
	public HttpPost(String url,RequestParams requestParams) {
		this(url,requestParams,null);
	}
	public HttpPost(String url,RequestParams requestParams,HttpHeaders headers) {
		super(url,requestParams,headers);
	}
	@Override
	public Request buildRequest() {
		return getRequestBuilder().post(getRequestBody()).build();
	}
